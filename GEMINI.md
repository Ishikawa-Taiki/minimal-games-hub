...
-   **プロジェクトマニフェスト (`docs/rules/project-manifest.md`)**
    ...
    -   **参照トリガー:** プロジェクトの全体像を理解する際、または大きな設計変更や方針決定を行う際は、**必ず**このドキュメントを参照し、プロジェクトの哲学と原則を再確認すること。
...
-   **技術ガイド - 開発ワークフロー (`docs/rules/technical-guide-development-workflow.md`)**
    ...
    -   **参照トリガー:** 開発作業を行う際、特にコミット、プッシュ、PR作成を行う際は、**必ず**このドキュメントを参照し、記載されたワークフローとルールを遵守すること。
...
-   **意思決定ログ (`docs/logs/decisions/`)**
    ...
    -   **参照トリガー:** 重要な設計判断や方針決定の経緯を確認する際は、このドキュメントを参照すること。
