...
import type { GameState, Line, Box } from './core';
        ...
        row.map((line, c) => (
          <div
            ...
            style={getLineStyle(line, {
              ...
              top: `${
                r * (CELL_SIZE + DOT_SIZE) + (DOT_SIZE - LINE_THICKNESS) / 2
              }px`,
            })}
        ...
        row.map((line, c) => (
          <div
            ...
            style={getLineStyle(line, {
              ...
              left: `${
                c * (CELL_SIZE + DOT_SIZE) + (DOT_SIZE - LINE_THICKNESS) / 2
              }px`,
            })}
...
const DotsAndBoxesGame: React.FC<DotsAndBoxesGameProps> = ({
  ...
  const { gameState, setDifficulty, selectLine, getPlayerDisplayName } = controller;
