...
### 9.1. `rules.md` (ゲームルール仕様書 - 想定読者: ユーザー)
...
### 9.3. `spec-action.md` (システム動作仕様書 - 想定読者: AIと開発者)
...
### 9.4. `spec-display.md` (システム表示仕様書 - 想定読者: AIと開発者)
...
このセクションでは、本プロジェクトにおける開発ワークフローやAIの行動規範について定義します。

## 11. AIの行動規範 (ドキュメント作成時)
