...
-   **技術ガイド - Spec Kitの統合 (`docs/rules/technical-guide-spec-kit.md`)**
    -   **役割:** AI駆動開発ワークフローを可能にするSpec Kitの統合、セットアップ、使用方法、およびリモートAIアシスタントに関する決定事項を定義します。
    -   **参照トリガー:** Spec Kitのセットアップ、使用方法、またはAI駆動開発の原則を理解する必要がある場合は、**必ず**このドキュメントを参照し、記載された手順と決定事項を遵守すること。
